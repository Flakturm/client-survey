...
class Auth extends MY_Controller {
	...
	function signup()
	{
		...
		$this->form_validation->set_rules('company_code', $this->lang->line('create_user_validation_company_label'), 'required');
		...
		else
		{
            ...
            $companies = $this->ion_auth_model->companies();
			...
			$this->data['company_code'] = array(
                ...
                'class' => 'form-control',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('company_code'),
			);
			...
			$this->_render('auth/signup', $this->data);
		}
	}
